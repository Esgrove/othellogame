...
TEST(disk_test, opponent_of_white)
{
    EXPECT_EQ(opponent(Disk::white), Disk::black);
}

TEST(disk_test, opponent_of_black)
{
    EXPECT_EQ(opponent(Disk::black), Disk::white);
}

TEST(disk_test, opponent_of_empty)
{
    EXPECT_EQ(opponent(Disk::empty), Disk::empty);
}

TEST(test_calculate_sha256, test)
{
    EXPECT_EQ(
...
TEST(test_calculate_sha256, log_line)
{
    EXPECT_EQ(
...
TEST(test_calculate_sha256, test_log)
{
    std::string test_log;
