...
import { calculateSha256, clamp } from '../src/utils.ts';
...
describe('utils', () => {
    ...
    test('calculate sha256 full log', () => {
        ...
        expect(calculateSha256(testLog)).toBe('ad4679949110ed7997aa1bf09441a7eb491b498189c03685ffdd6ddbb70e3c22');
    });
});
